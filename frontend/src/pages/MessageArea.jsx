  ...
  return (
    <div className="w-full h-[100vh] bg-black relative">
      <div className="flex items-center gap-[15px] px-[20px] py-[10px] fixed top-0 z-[100] bg-black w-full">
        <div className=" h-[10px] flex items-center gap-[20px] px-[20px] py-[15px]">
      ...
      <div className="w-full h-[80%] pt-[100px] pb-[100px] px-[40px] flex flex-col gap-[50px] overflow-auto bg-black">
        {messages &&
      ...
      <div className="w-full h-[80px] fixed border-0 flex justify-center items-center bg-black z-[100]">
        <form
